const InfoProduct = () =>{
    return(
        ...
        <div className="relative mb-12 px-2 lg:mb-0">
        ...
        <div className="relative mb-12 px-2 lg:mb-0">
            ...
            <h6 className="mx-6 font-normal dark:text-neutral-50  text-center">Livre de sulafato, parabenos, alumínio, corante artificias, óleos minerais, silicones e petrolatos</h6>
            <div
            className="absolute right-0 top-0 hidden h-full min-h-[1em] w-px self-stretch border-t-0 bg-gradient-to-tr from-transparent via-neutral-500 to-transparent opacity-25 dark:opacity-100 lg:block"></div>
        </div>
        <div className="relative mb-12 px-2 lg:mb-0 items-center justify-center">
