            ...
            <form>
                ...
                <div className="mb-6 flex items-center justify-between">        
                    <div className="block min-h-[1.5rem] pl-[1.5rem]">
                        ...
                        <label className="inline-block pl-[0.15rem] hover:cursor-pointer" for="exampleCheck2">Lembrar-me</label>
                    </div>
                ...
                <a href="#!" className="text-gray-950 font-semibold transition duration-150 ease-in-out hover:text-primary-600 focus:text-primary-600 active:text-primary-700 dark:text-primary-400 dark:hover:text-primary-500 dark:focus:text-primary-500 dark:active:text-primary-600"
                > Cadastre-se</a>
                </p>
            </form>
            </div>
